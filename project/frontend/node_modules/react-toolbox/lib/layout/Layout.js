...
var factory = function factory(AppBar, NavDrawer, Sidebar) {
  ...
  Layout.propTypes = {
    ...
    theme: _react.PropTypes.shape({
      appbarFixed: _react.PropTypes.string,
      layout: _react.PropTypes.string,
      navDrawerClipped: _react.PropTypes.string,
      navDrawerPinned: _react.PropTypes.string,
      sidebarClipped: _react.PropTypes.string,
      sidebarPinned: _react.PropTypes.string
    })
  };
  Layout.defaultProps = {
    className: ''
